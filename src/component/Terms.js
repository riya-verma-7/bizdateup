...
const termsSidebar = [
  ...
  {
    id: "3",
    title: "Information about us and the Bizdateup platform",
    path: "3",
  },
  {
    id: "4",
  ...
  {
    id: "6",
    title: "Password to the Website",
    path: "6",
  },

  {
    id: "7",
    title: "Representations and Warranties of Users",
    path: "7",
  },
  {
    id: "8",
    title: "Our rights in relation to the Website",
    path: "8",
  },
  {
    id: "9",
...
<main>
    <section>
       <div className="sidebar termsSidebar ">
        <ul>
          {termsSidebar.map((item, id) => {
            return (
              <>
...
Terms of Use
</h3> <p className="text-muteds f-17 mt-3">
 ...
 </p> <img src={HomeUrl} height="15" className="mt-3" alt="" /> </div> </Col> </Row> </section>
