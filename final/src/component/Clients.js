...
Running a startup is challenging. To cater to these issues,<br/> BizDateUp keeps coming up with services that fit every need that a founder can think of while running a startup.
            ...
            <Row className="mt-5 pt-4">
              <Col lg={3} md={4} sm={6}>
                ...
                <h4 className="title-heading mt-4 p-2 text-center" style = {{background: "#202054",  borderRadius: "5px", color: '#ffffff'}}>Pitch Deck</h4>
                </div>
              </Col>
              <Col lg={3} md={4} sm={6}>
                <div className="client-images mt-4">
                <h4 className="title-heading mt-4 p-2 text-center" style = {{background: "#202054",  borderRadius: "5px", color: '#ffffff'}} >Mentorship Sessions</h4>              
                 </div>
              </Col>
              <Col lg={3} md={4} sm={6}>
                <div className="client-images mt-4">
                <h4 className="title-heading mt-4 p-2 text-center" style = {{background: "#202054",  borderRadius: "5px", color: '#ffffff'}}>Legal Solutions</h4>
                               </div>
              </Col>
              <Col lg={3} md={4} sm={6}>
                <div className="client-images mt-4">
                <h4 className="title-heading mt-4 p-2 text-center" style = {{background: "#202054",  borderRadius: "5px", color: '#ffffff'}}>Website and App</h4>                
                </div>
              </Col>
              <Col lg={3} md={4} sm={6}>
                <div className="client-images mt-4">
                <h4 className="title-heading mt-4 p-2 text-center" style = {{background: "#202054",  borderRadius: "5px", color: '#ffffff'}}>Intern & Hr recruitment</h4>                
                </div>
              </Col>
              <Col lg={3} md={4} sm={6}>
                <div className="client-images mt-4">
                <h4 className="title-heading mt-4 p-1  text-center " style = {{background: "#202054",  borderRadius: "5px", color: '#ffffff'}}>Employee financial planning</h4>                
                </div>
              </Col>
              <Col lg={3} md={4} sm={6}>
                <div className="client-images mt-4">
                <h4 className="title-heading mt-4 p-2 text-center " style = {{background: "#202054",  borderRadius: "5px", color: '#ffffff'}}>Talent management</h4>                
                </div>
              </Col>
              <Col lg={3} md={4} sm={6}>
                <div className="client-images mt-4">
                <h4 className="title-heading mt-4 p-2 text-center " style = {{background: "#202054",  borderRadius: "5px", color: '#ffffff'}}>Market consultancy</h4>                
                </div>
              </Col>
            </Row>
          </Container>
